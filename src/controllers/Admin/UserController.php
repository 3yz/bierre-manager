...
class UserController extends BaseAdminController {
    ...
    $this->layout->content = \View::make('manager::admin.user.index', compact('users'));
	}
    ...
    $this->layout->content = \View::make('manager::admin.user.create')
      ->with('user', new \User())
    ...
    try {
      ...
      $adminGroup = Sentry::findGroupById($input['group_id']);
    ...
    $this->layout->content = \View::make('manager::admin.user.edit', compact('user', 'groups'));
	}
